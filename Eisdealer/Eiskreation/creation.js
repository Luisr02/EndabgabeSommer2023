...
(function (eisdealer) {
    ...
    function handleLoad() {
        ...
        generateInputElements(eisdealer.flavourOptions, "flavouroptions", "radio");
        generateInputElements(eisdealer.sauceOptions, "sauceoptions", "checkbox");
    ...
    function generateScoopNumberOptions(_maxScoops, _containerId) {
        let container = document.getElementById(_containerId);
        ...
        select.addEventListener("change", (event) => {
            currentIceCream.scoopnumber = parseInt(event.target.value);
            console.log(currentIceCream);
            updatePrice();
            displayIceCream();
        });
    ...
    function addElementToIceCream(_element) {
    ...
    function updateInputElements() {
        console.log("update");
        eisdealer.flavourOptions.forEach((flavour, index) => {
            console.log(flavour);
    ...
    function resetIceCream() {
        console.log("reset");
        let scoopNumberSelect = document.querySelector(".numberofscoopsoptions");
